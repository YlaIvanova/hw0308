public class Main {
    ...
    public static void main(String[] args) {
        ...
        // или телефона, а также мобильное приложение. И нам, и клиенту удобнее с телефона
        // пользоваться мобильным приложением. Поэтому каждый раз, когда пользователь заходит на сайт с телефона,
        ...
        // банковских карт на дом с четкой датой доставки. Чтобы известить клиента о том,
        ...
        int interval = 40;
        int distanceDifferenceKm = 20;
        if (deliveryDistance <= distanceDifferenceKm) {
            deliveryPerDay = 1;
        } else {
            deliveryPerDay = deliveryPerDay + (int) Math.ceil((deliveryDistance - distanceDifferenceKm) / (double) interval);
        }
